...
enum MyStrings:String
{
    ...
    case more = "Ещё"
    case close = "Закрыть"
    case dear_guests = "Дорогие гости"
    case skip = "Пропустить"
    case futher = "Далее"
    case start = "Начать"
    case review_saved = "Отзыв сохранен"
    case cofe = "Кофе"
    case orders = "Заказы"
    case reviews = "Отзывы"
    case refreshing = "Обновление"
    case no_reviews_yet = "Отзывы пока не доступны, но совсем скоро вы сможете стать первым, кто это сделает"
    ...
    static func getOffertText()->String
    {
        ...
        <p dir="ltr">
        2.3. Агрегатор – Агрегатор – ООО «ДЖОК», ОГРН: 1217700201839, ИНН:7707452396,
        обеспечивающий информационно-технологическое сопровождение взаимодействия между
    ...
    static let test_user =
    """
    {
        "name":"John Test",
        "email":"Bios90@mail.ru",
        "reviews_count":"0",
        "cups_count":"0",
        "orders_count":"0",
        "push_token":[],
        "api_token":"18AzX3fHPs6Z1SCYC1bJXUpfWWpUILme",
        "phone":"79175304686",
        "created_at":"05.03.2021 20:03:18",
        "updated_at":"05.03.2021 20:06:51",
        "confirmed":true,
        "reviews":[],
        "image":
        {
            ...
            "id":0,
            "height":250,
            "src":"https://justordercompany.com/media/cache/resolve/api_avatar_src/uploads/client/8733051b18e550a778f94dba03fb6876.png",
            "url_s":"https://justordercompany.com/media/cache/resolve/api_avatar_s/uploads/client/8733051b18e550a778f94dba03fb6876.png",
            "url_m":"https://justordercompany.com/media/cache/resolve/api_avatar_m/uploads/client/8733051b18e550a778f94dba03fb6876.png",
            "url_l":"https://justordercompany.com/media/cache/resolve/api_avatar_l/uploads/client/8733051b18e550a778f94dba03fb6876.png"
        }
    }
    """
}
